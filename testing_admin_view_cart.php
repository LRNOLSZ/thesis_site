...
if (isset($_POST['update_product_quantity'])) {
  ...
  if ($update_quantity_query) {
    header('Location: testing_admin_view_cart.php');
    exit(); // Add an exit to prevent further execution
  }
}
  ...
  <div class="hoo">
      ...
      ?>
          <tr>
            ...
            <td class="text-center">
              <a href="testing_admin_view_cart.php?remove=<?php echo $fetch_cart_products['ID']; ?>" class="delete_product_btn" onclick="return confirm('Are you sure you want to delete this product?');">
    ...
    ?>
      ...
      <div class="delete_bt">
        ...
        <a href="testing_admin_view_cart.php?delete_all" class="btn btn-danger"><i class="fas fa-trash"></i>Delete all</a>
      </div>
    <?php
    }
    ?>
