...
rel = "stylesheet" / >
    ...
    <!--fa icons-- >
    <script src = "https://kit.fontawesome.com/87a971dd65.js"
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ending_nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" href="fp.php"><i class="fa fa-key"
                        ...
                        <li class="nav-item nav-link">
                            ...
                            <i id="cartButton" data-bs-toggle="modal" data-bs-target="#cartModal"
                                class="fa fa-cart-arrow-down" aria-hidden="true">ghgh</i>
    ...
    ?>
        ...
        ?>
                <div class="col-md-4">
                    ...
                    <img src="<?php echo $row['img_url']; ?>" class="img-fluid rounded sig_img"
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <div class="text-body-secondary col bt_flex ">
                            ...
                            <button
                                onclick=<?php echo " \" addTocart('" . $row['price'], "','" . $row['name'] . "','" . $row['ID'] . "')   \"  " ?>
                                class="btn btn_sig btn-primary btn-lg add-to-cart">Add to Cart</button>
                        </div>
                        </p>
                    </div>
                </div>
      ...
      ?>
            <div class="col-lg-3 col-md-6 col-sm-6 beverage_row" id="num1">
                <div class="card ca_bg">
                    <img src="<?php echo $row['img_url']; ?>" class="card-img-top rounded bo-img"
                        alt="<?php echo $row['name']; ?>">
